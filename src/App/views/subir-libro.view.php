    ...
    <main>
        ...
        <section class="subir-libro">
            <form id="formSubirLibro" class="subir-libro-form" action="/procesar-libro" method="post"
                ...
                <input id="titulo" type="text" name="titulo" placeholder="Título del libro">
                ...
                <textarea id="descripcion" name="descripcion" placeholder="Resumen del libro"></textarea>
                <span id="error-descripcion" class="error-message" aria-live="polite"></span>

                <label for="precio">Precio (ARS)*</label>
                <input id="precio" type="number" name="precio" placeholder="Ej: 25000">
